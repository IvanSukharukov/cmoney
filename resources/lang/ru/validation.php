...
return [
    ...
    */
    ...
    'prices_count_not_match' => 'Количество элементов должно быть равным :size.',
    'film_free_in_paid_compilation' => 'Бесплатный фильм не может быть в платных подборках.',
    'compilation_paid_have_free_film' => 'Платная подборка не может содержать бесплатные фильмы.',
    'group_invite_email_exists' => 'Пользователь должен быть зарегистрирован в «Ноль плюс»',
